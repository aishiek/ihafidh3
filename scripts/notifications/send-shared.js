...
// Convert offset number to timezone string format
// Example: 5.5 -> "+0530", -9.5 -> "-0930"
...
function getDailyAyah(localDate) {
    ...
    // MATCH APP LOGIC: (dayOfYear - 1) to map day 1-365 to index 0-364
    const index = (dayOfYear - 1) % ayahList.length;
