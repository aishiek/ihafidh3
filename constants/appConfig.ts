...
export const MIN_SUPPORTED_VERSION = '2.0.1'; // Local fallback minimum supported version
export const LATEST_VERSION = '2.0.1'; // Local fallback latest version for soft prompts
