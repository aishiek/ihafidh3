...
export const MIN_SUPPORTED_VERSION = '1.3.1'; // Local fallback minimum supported version
export const LATEST_VERSION = '1.3.1'; // Local fallback latest version for soft prompts
